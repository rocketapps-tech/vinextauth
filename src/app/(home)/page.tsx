...
const features = [
  {
    ...
    title: 'Edge-first',
    description:
      'Runs natively on Cloudflare Workers. No Node.js APIs — pure Web Crypto everywhere.',
  },
  {
    icon: (
      <svg viewBox="0 0 20 20" fill="currentColor" width={20} height={20}>
  ...
  },
  {
    ...
    title: '12 providers',
    description:
      'Google, GitHub, Discord, Apple, Microsoft and more. Plus credentials and magic link email.',
  },
  {
    icon: (
      <svg viewBox="0 0 20 20" fill="currentColor" width={20} height={20}>
  ...
  },
  {
    ...
    description:
      'Built-in double-submit CSRF protection and configurable credentials rate limiting.',
  },
];
    ...
    <>
      ...
      <section className="lp-hero">
        ...
        <p className="lp-description">
          VinextAuth is a zero-dependency authentication library built on the Web Crypto API. Same
          API as NextAuth v4, but runs anywhere at the edge.
        </p>
