    ...
    <>
      ...
      <section className="lp-section">
        <div className="lp-code-wrap">
          <h2 className="lp-section-title">Pronto em minutos</h2>
          <p className="lp-section-sub">Funciona com sua config existente do NextAuth.</p>
  ...
  callbacks: {
    async session({ session, token }) {
      ...
      return session;
          ...
          <Link href="/pt/docs/getting-started" className="lp-link">
            Ver o guia completo de configuração &rarr;
          </Link>
        </div>
      </section>
